    ...
    <footer className="mt-auto border-t border-[#c9a227]/30 bg-[#fbf8ef] text-stone-800">
      <div className="mx-auto max-w-6xl px-5 py-8 sm:px-8 lg:py-10">
        <div className="grid gap-8 md:grid-cols-3 md:gap-10">
          ...
          {/* Sağ sütun: Kaynaklar ve sosyal bağlantılar */}
          <section aria-labelledby="footer-kaynaklar">
            ...
            <button
              ...
              className="group inline-flex items-center gap-2 border-none bg-transparent p-0 text-sm font-semibold text-stone-700 transition-colors hover:text-[#8b1e1e] cursor-pointer"
            >
