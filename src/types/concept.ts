import { Concept } from '../domain/concept/Concept';   // ← gerçek sınıfı import et
...
export class InMemoryConceptRepository {
  ...
  async findAll(): Promise<any[]> {                    // ← EKLE
    return Array.from(this.concepts.values());
  }

  async delete(id: string): Promise<boolean> {
    return this.concepts.delete(this.toKey(id));       // ← "retaurn" → "return"
  }
