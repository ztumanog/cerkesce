...
function useDictionary() {
    ...
    }["useDictionary.useEffect"], []); // Bağımlılıklar boş: Sadece ilk açılışta 1 kez çalışır!
    const filtrelenmisSonuclar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Cerkesce$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDictionary.useMemo[filtrelenmisSonuclar]": ()=>{
            ...
            if (q) {
                veri = veri.filter({
                    "useDictionary.useMemo[filtrelenmisSonuclar]": (i)=>i.kelime.toLowerCase().includes(q) || i.tanim.toLowerCase().includes(q)
                }["useDictionary.useMemo[filtrelenmisSonuclar]"]);
            }
            return veri;
        }
...
_s(useDictionary, "S2+GLGekt4QjAkhpu2cOgGalZ+E=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Cerkesce_1qkxef0._.js.map