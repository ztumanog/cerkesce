...
const SearchBox = ({ inputRef, searchQuery, setSearchQuery, mod, setMod, hedefDil, setHedefDil, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, aktifSozlukler = [], setGoruntulenenAdet, limit = 20, tema = {} })=>{
    ...
    const sozlukKatalogu = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchBox.useMemo[sozlukKatalogu]": ()=>jsonKatalogunuAl()
    }["SearchBox.useMemo[sozlukKatalogu]"], []);
                ...
                children: [
                    ...
                    listeAcik && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            grupluSozlukler.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SearchBox, "6Srs7e1jQQwfZP9HSZ1cYS97AyE=");
_c = SearchBox;
                        ...
                        anlamlar: kaynaklar.map({
                            "SozlukEkrani.useMemo[gruplanmisSonuclar]": (k)=>{
                                ...
                                if (Array.isArray(k.definitions) && k.definitions.length > 0 && k.definitions[0]?.meaning) {
                                    secilenTanim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["metneCevir"])(k.definitions[0].meaning);
                                } else if (k.full_definition_in_html) {
                                    secilenTanim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["metneCevir"])(k.full_definition_in_html);
                                } else {
                                    secilenTanim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["metneCevir"])(k.tanim || k.meaning);
                                }
    ...
    const dinamikSozlukSayisi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SozlukEkrani.useMemo[dinamikSozlukSayisi]": ()=>{
            ...
            if (lehceMetni && ![
                ...
                const kaynakListe = Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]) && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] : aktifSozlukler;
                if (Array.isArray(kaynakListe)) {
                    return kaynakListe.filter({
                        "SozlukEkrani.useMemo[dinamikSozlukSayisi]": (s)=>{
                            const item = s;
                    ...
                    }["SozlukEkrani.useMemo[dinamikSozlukSayisi]"]).length;
                }
            }
            ...
            if (filtreVarMi) {
                ...
                if (Array.isArray(aktifSozlukler) && aktifSozlukler.length > 0) {
                    return aktifSozlukler.reduce({
                        "SozlukEkrani.useMemo[dinamikKayitSayisi]": (acc, sozluk)=>{
...
//# sourceMappingURL=_0et0a8_._.js.map