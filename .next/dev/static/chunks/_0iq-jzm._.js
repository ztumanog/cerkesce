...
function useDictionary() {
    ...
    const [rawItems, setRawItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const normalizeText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDictionary.useCallback[normalizeText]": (str = "")=>{
            return str.toLowerCase().replace(/I/g, "ı").replace(/İ/g, "i").trim();
        }
    }["useDictionary.useCallback[normalizeText]"], []);
    // Tanım Öncelik Hiyerarşisi Ayrıştırıcı
    const extractTanimMetni = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDictionary.useCallback[extractTanimMetni]": (item)=>{
            return item.definitions?.[0]?.meaning || item.full_definition_in_html || (typeof item.tanim === "string" ? item.tanim : "") || item.meaning || "";
        }
    }["useDictionary.useCallback[extractTanimMetni]"], []);
    ...
    const normalizedIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDictionary.useMemo[normalizedIndex]": ()=>{
            return rawItems.map({
                "useDictionary.useMemo[normalizedIndex]": (item)=>({
                        item,
    ...
    const filtrelenmisSonuclar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useDictionary.useMemo[filtrelenmisSonuclar]": ()=>{
            ...
            return normalizedIndex.filter({
                "useDictionary.useMemo[filtrelenmisSonuclar]": ({ item, normalizedKelime, normalizedTanim })=>{
                    // Lehçe Filtresi
            ...
            }["useDictionary.useMemo[filtrelenmisSonuclar]"]).map({
                "useDictionary.useMemo[filtrelenmisSonuclar]": (entry)=>entry.item
            }["useDictionary.useMemo[filtrelenmisSonuclar]"]);
        }
    }["useDictionary.useMemo[filtrelenmisSonuclar]"], [
        searchQuery,
...
_s(useDictionary, "K8kNgaj4ELXz3IZkzn/tLJKiaUU=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0iq-jzm._.js.map