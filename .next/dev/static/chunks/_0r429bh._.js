...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$KelimeDetayDrawer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/KelimeDetayDrawer.tsx [app-client] (ecmascript)"); // İsim düzeltildi
...
function AnaSayfa() {
    ...
    const { loading, searchQuery, setSearchQuery, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, gununKelimesi, filtrelenmisSonuclar, aktifSozlukler } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDictionary$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDictionary"])();
    ...
    // 1. Gruplama İşlemi (Performans için useMemo ile sarmalandı)
    const gruplanmisSonuclar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AnaSayfa.useMemo[gruplanmisSonuclar]": ()=>{
            if (!searchQuery.trim() || !filtrelenmisSonuclar) return [];
            const gruplar = new Map();
            filtrelenmisSonuclar.forEach({
                "AnaSayfa.useMemo[gruplanmisSonuclar]": (item)=>{
            ...
            return Array.from(gruplar.values()).map({
                "AnaSayfa.useMemo[gruplanmisSonuclar]": (kaynaklar)=>({
    ...
    // 2. Tıklama olayları için referans koruması (useCallback)
    const handleKelimeSec = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AnaSayfa.useCallback[handleKelimeSec]": (grup)=>{
            setSeciliKelimeGrubu(grup);
        }
    }["AnaSayfa.useCallback[handleKelimeSec]"], []);
    const handlePanoyaKopyala = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AnaSayfa.useCallback[handlePanoyaKopyala]": async (kelime, tanim, id)=>{
            const metin = `${kelime}\n${tanim || ""}`;
            try {
                ...
                if (id) {
                    setKopyalandiId(id);
                    setTimeout({
                        "AnaSayfa.useCallback[handlePanoyaKopyala]": ()=>setKopyalandiId(null)
                    }["AnaSayfa.useCallback[handlePanoyaKopyala]"], 2000);
                }
            } catch (err) {
                console.warn("Kopyalama engellendi:", err);
            }
        }
    }["AnaSayfa.useCallback[handlePanoyaKopyala]"], []);
    // 3. Render edilecek veriyi limitle (Virtualization hazırlığı)
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                ...
                !searchQuery.trim() && gununKelimesi && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(GununKelimesiKarti, {
...
_s(AnaSayfa, "gqqpDdM2czdNWNj030VMrim0H3o=", false, function() {
    return [
...
_c = AnaSayfa;
var _c;
__turbopack_context__.k.register(_c, "AnaSayfa");
...
_s(SozlukEkrani, "zpfhS5AtJ8mv0psA4vpzGeSZovg=");
_c = SozlukEkrani;
var _c;
...
//# sourceMappingURL=_0r429bh._.js.map