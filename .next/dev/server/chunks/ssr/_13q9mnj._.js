...
function SozlukEkrani({ loading, searchQuery, setSearchQuery, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, gununKelimesi, filtrelenmisSonuclar, aktifSozlukler }) {
   ...
   */ const dinamikSozlukSayisi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        /*
     * Arama yapılıyorsa sonuçlardaki farklı kaynakları say.
     */ if (searchQuery?.trim()) {
        ...
        /*
     * Belirli bir dosya seçildiyse
     * yalnızca bir sözlük gösterilir.
     */ if (dosyaMetni && ![
            "tumu",
            "all",
            "hepsi"
        ...
        const lehceFiltresiVarMi = lehceMetni !== "" && ![
            "tumu",
            "all",
            "hepsi"
        ].includes(lehceMetni);
        /*
     * Lehçe filtresine göre sözlükleri say.
     */ if (lehceFiltresiVarMi && Array.isArray(aktifSozlukler)) {
            const lehceyeGoreSozlukler = aktifSozlukler.filter((sozluk)=>{
                if (!sozluk || typeof sozluk !== "object") {
                    return false;
                }
                const sozlukObj = sozluk;
                const dialect = String(sozlukObj.dialect ?? sozlukObj.lehce ?? sozlukObj.diyalekt ?? "").trim().toLowerCase();
                if (!dialect) {
                    return false;
                }
        ...
        /*
     * Hiç filtre yoksa aktif sözlüklerin tamamı.
    ...
    /*
   * Arama ve filtreye göre dinamik kayıt sayısı
   */ const dinamikKayitSayisi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        /*
     * Arama yapıldığında her kelime grubundaki
     * kaynak kayıtlarını toplar.
     */ if (searchQuery?.trim()) {
        ...
        /*
     * Filtre seçiliyse aktif sözlüklerin
     * kayıt sayılarını toplar.
     */ if (filtreVarMi && Array.isArray(aktifSozlukler)) {
        ...
        /*
     * Hiç filtre yoksa tüm aktif sözlüklerin
     * kayıt sayılarını toplar.
     */ if (Array.isArray(aktifSozlukler) && aktifSozlukler.length > 0) {
            const toplamKayit = aktifSozlukler.reduce((toplam, sozluk)=>{
                if (!sozluk || typeof sozluk !== "object") {
                    return toplam;
                }
                const sozlukObj = sozluk;
        ...
        /*
     * Eğer sözlük metadata'sında sayılar yoksa
     * buradaki varsayılan toplam kullanılır.
     */ return 332238;
    }, [
        searchQuery,
        gruplanmisSonuclar,
...
//# sourceMappingURL=_13q9mnj._.js.map