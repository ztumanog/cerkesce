...
"[project]/src/components/dictionary/GununKelimesiKart.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GununKelimesiKarti({ gununKelimesi, metinBoyutu, tema, onClick }) {
   ...
   */ const arkaPlanRengi = tema.kartArkaPlan || tema.arkaPlan;
    ...
    const vurguRengi = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dictionaryConstants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["KURUMSAL"].kirmizi || anaYaziRengi;
   ...
   */ const metaObj = dosyaAdi ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dictionaryConstants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SOZLUK_META"][dosyaAdi] : undefined;
    ...
    if (metaObj) {
        ...
        const duzenlenmis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["kaynagiDuzenle"])(dosyaAdi);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$helpers$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["tanimlariBicimlendir"])(tanimMetni, tema, gununKelimesi.kelime, metinBoyutu, kaynakIsmi)
            }, void 0, false, {
                fileName: "[project]/src/components/dictionary/GununKelimesiKart.tsx",
                lineNumber: 159,
                columnNumber: 7
...
const degeriNormallestir = (deger)=>{
    return String(deger ?? "").trim().toLocaleLowerCase("tr-TR");
};
const alanDegeriBul = (sozluk, alanlar)=>{
    for (const alan of alanlar){
        const deger = sozluk[alan];
...
const sozlukAdiBul = (sozluk)=>{
    return alanDegeriBul(sozluk, [
        "name",
        "ad",
        "title",
        "sozlukAdi",
...
const lehceBasligiBul = (lehce)=>{
    const deger = degeriNormallestir(lehce);
    if (deger.includes("doğu") || deger.includes("dogu") || deger.includes("kabardey") || deger === "kbd") {
        return "BATI ADIĞECE";
    }
    if (deger.includes("batı") || deger.includes("bati") || deger.includes("adıge") || deger.includes("adige") || deger === "ady") {
        return "BATI ADIĞECE";
    }
    return "DİĞER KAYNAKLAR";
};
const lehceEslesiyorMu = (sozlukLehcesi, seciliLehce)=>{
    const kaynak = degeriNormallestir(sozlukLehcesi);
    const secili = degeriNormallestir(seciliLehce);
    if (!secili || tumLehceDegerleri.includes(secili)) {
        return true;
    }
    if (secili.includes("doğu") || secili.includes("dogu") || secili.includes("kabardey") || secili === "kbd") {
        return kaynak.includes("doğu") || kaynak.includes("dogu") || kaynak.includes("kabardey") || kaynak === "kbd";
    }
    if (secili.includes("batı") || secili.includes("bati") || secili.includes("adıge") || secili.includes("adige") || secili === "ady") {
        return kaynak.includes("batı") || kaynak.includes("bati") || kaynak.includes("adıge") || kaynak.includes("adige") || kaynak === "ady";
    }
    return kaynak.includes(secili);
};
const SearchBox = ({ inputRef, searchQuery, setSearchQuery, mod, setMod, hedefDil, setHedefDil, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, aktifSozlukler = [], setGoruntulenenAdet, limit = 20, tema = {} })=>{
    const [sozlukKatalogu, setSozlukKatalogu] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [listeAcik, setListeAcik] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [geliyor, setGeliyor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        let iptalEdildi = false;
        const kataloguGetir = async ()=>{
            try {
                const cevap = await fetch("/src/utils/dictionary.json", {
                    cache: "no-store"
                });
                if (!cevap.ok) {
                    throw new Error(`dictionary.json yüklenemedi: ${cevap.status}`);
                }
                ...
                if (Array.isArray(veri)) {
                    ...
                    const veriObj = veri;
                    const olasiListe = veriObj.dictionaries ?? veriObj.dictionary ?? veriObj.sozlukler ?? veriObj.data ?? [];
                    if (Array.isArray(olasiListe)) {
                        liste = olasiListe;
                    }
                }
                const temizListe = liste.filter((item)=>Boolean(item && typeof item === "object"));
                if (!iptalEdildi) {
                    setSozlukKatalogu(temizListe);
                }
            } catch (hata) {
                console.error("Sözlük kataloğu yüklenemedi:", hata);
                if (!iptalEdildi) {
                    setSozlukKatalogu([]);
                }
            } finally{
    ...
    const kullanilacakSozlukler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (sozlukKatalogu.length > 0) {
            return sozlukKatalogu;
        }
    ...
    const filtrelenmisSozlukler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        return kullanilacakSozlukler.filter((sozluk)=>lehceEslesiyorMu(sozlukLehcesiBul(sozluk), seciliLehce));
    }, [
        kullanilacakSozlukler,
        seciliLehce
    ]);
    const grupluSozlukler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const gruplar = new Map();
        filtrelenmisSozlukler.forEach((sozluk)=>{
            const lehce = sozlukLehcesiBul(sozluk);
            const baslik = lehceBasligiBul(lehce);
            if (!gruplar.has(baslik)) {
                gruplar.set(baslik, []);
            }
            gruplar.get(baslik)?.push(sozluk);
        });
        return Array.from(gruplar.entries());
    }, [
        filtrelenmisSozlukler
    ]);
    const seciliDosyaAdi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!seciliDosya || tumLehceDegerleri.includes(degeriNormallestir(seciliDosya))) {
            if (seciliLehce && !tumLehceDegerleri.includes(degeriNormallestir(seciliLehce))) {
                return `Tüm ${seciliLehce} sözlükleri`;
            }
            return "Tüm Sözlüklerde Ara";
        }
        return seciliDosya;
    }, [
        seciliDosya,
    ...
    const doslukSec = (sozlukAdi)=>{
        setSeciliDosya(sozlukAdi);
        setGoruntulenenAdet(limit);
        setListeAcik(false);
    };
    const ortakTema = {
        backgroundColor: tema.kartArkaPlan || "#FFFFFF",
        borderColor: tema.kenarlik || "#EADDC9",
        color: tema.yaziAna || "#2C221E"
    };
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                ...
                                placeholder: "tanım veya kök ara...",
                                className: "min-w-0 flex-1 bg-transparent text-base outline-none placeholder:text-[#9D918C]"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                lineNumber: 435,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "hidden text-xs italic text-[#9D918C] md:block",
                                children: "Örn: nca, adige, yürek"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                lineNumber: 450,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-wrap items-center gap-3 border-t bg-[#FCFAF8] px-5 py-4",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "mr-1 text-xs font-bold tracking-wider text-[#8C7A6B]",
                                children: "LEHÇE"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                lineNumber: 456,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: `rounded-full border px-4 py-2 text-sm font-semibold transition ${!seciliLehce || tumLehceDegerleri.includes(degeriNormallestir(seciliLehce)) ? "border-[#C0002B] bg-[#C0002B] text-white shadow-md" : "border-[#E5D9D0] bg-white text-[#493B35]"}`,
                                children: [
                                    "Tümü",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("small", {
                                        className: "ml-1 block text-[10px] font-normal opacity-75",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>{
                                    setSeciliLehce("Batı Adığece");
                                    setSeciliDosya("tumu");
                                    setGoruntulenenAdet(limit);
                                },
                                className: `rounded-full border px-4 py-2 text-sm font-semibold transition ${degeriNormallestir(seciliLehce).includes("batı") || degeriNormallestir(seciliLehce).includes("bati") ? "border-[#C0002B] bg-[#C0002B] text-white shadow-md" : "border-[#E5D9D0] bg-white text-[#493B35]"}`,
                                children: [
                                    "Batı",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("small", {
                                        className: "ml-1 block text-[10px] font-normal opacity-75",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>{
                                    setSeciliLehce("Doğu Kabardeyce");
                                    setSeciliDosya("tumu");
                                    setGoruntulenenAdet(limit);
                                },
                                className: `rounded-full border px-4 py-2 text-sm font-semibold transition ${degeriNormallestir(seciliLehce).includes("doğu") || degeriNormallestir(seciliLehce).includes("dogu") || degeriNormallestir(seciliLehce).includes("kabardey") ? "border-[#C0002B] bg-[#C0002B] text-white shadow-md" : "border-[#E5D9D0] bg-white text-[#493B35]"}`,
                                children: [
                                    "Doğu",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("small", {
                                        className: "ml-1 block text-[10px] font-normal opacity-75",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>setMod(mod === "akilli" ? "normal" : "akilli"),
                                        className: `rounded-full border px-4 py-2 text-sm font-semibold ${mod === "akilli" ? "border-[#C0002B] bg-[#FFF5F5] text-[#7A1C1C]" : "border-[#DCCEC5] bg-white text-[#493B35]"}`,
                                        children: "⌨ Akıllı Klavye"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                        lineNumber: 524,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "px-2 text-xl text-[#A3948C]",
                                        "aria-label": "Temizle",
                                        children: "×"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: aramaYap,
                                        className: "rounded-full bg-[#B0003A] px-5 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-[#8F0030]",
                                        children: "Ara"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                        lineNumber: 555,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        onClick: ()=>setListeAcik((onceki)=>!onceki),
                        className: "flex w-full items-center justify-between rounded-lg border px-4 py-3 text-left text-sm font-semibold",
                        style: ortakTema,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "truncate",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: `ml-3 transition ${listeAcik ? "rotate-180" : ""}`,
                                children: "▾"
                            }, void 0, false, {
                                fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                lineNumber: 579,
                    ...
                    listeAcik && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute left-0 right-0 top-full z-50 mt-1 max-h-80 overflow-y-auto rounded-b-lg border bg-white shadow-xl",
                        style: ortakTema,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                                onClick: ()=>doslukSec("tumu"),
                                className: "flex w-full items-center gap-2 border-b px-4 py-3 text-left text-sm font-bold text-[#7A1C1C] transition hover:bg-[#FDF2F2]",
                                children: [
                                    "📚",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: "Tüm Sözlüklerde Ara"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                        lineNumber: 601,
                                        columnNumber: 15
                            ...
                            geliyor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "px-4 py-4 text-sm text-[#8C7A6B]",
                                children: "Sözlükler yükleniyor..."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                lineNumber: 607,
                                columnNumber: 15
                            }, ("TURBOPACK compile-time value", void 0)),
                            !geliyor && grupluSozlukler.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "px-4 py-4 text-sm text-[#8C7A6B]",
                                children: "Bu lehçeye ait sözlük bulunamadı."
                            }, void 0, false, {
                                fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                                lineNumber: 614,
                                columnNumber: 17
                            }, ("TURBOPACK compile-time value", void 0)),
                            grupluSozlukler.map(([baslik, sozlukler])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "border-t px-4 pb-2 pt-3 text-[10px] font-bold uppercase tracking-[1.5px] text-[#C0002B]",
                                            children: [
                                                "─── ",
                                                baslik,
                                                " ───"
                                        ...
                                        sozlukler.map((sozluk, index)=>{
                                            const ad = sozlukAdiBul(sozluk);
                                            const yazar = sozlukYazariBul(sozluk);
                                            const yil = sozlukYiliBul(sozluk);
                                            if (!ad) {
                                                return null;
                                            }
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                type: "button",
                                                onClick: ()=>doslukSec(ad),
                                                className: "flex w-full items-center justify-between gap-4 border-t px-4 py-2.5 text-left text-[13px] transition hover:bg-[#FDF2F2]",
                                                style: {
                                                    borderColor: tema.kenarlik || "#EADDC9",
                                                    color: tema.yaziAna || "#2C221E"
                                                },
                                                children: [
                                                    ...
                                                    (yazar || yil) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "shrink-0 text-right text-xs italic",
                                                        style: {
                                                            color: tema.yaziAlt || "#8C7A6B"
                                                        },
                                                        children: [
                                                            yazar,
                                                            yazar && yil ? " " : "",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                ].map(([deger, etiket])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        type: "button",
                        onClick: ()=>setHedefDil(deger),
                        className: `rounded-full border px-4 py-2 text-sm ${hedefDil === deger ? "border-[#7A1C1C] bg-[#7A1C1C] text-white" : "border-[#E5D9D0] bg-white text-[#493B35]"}`,
                        children: etiket
                    }, deger, false, {
                        fileName: "[project]/src/components/dictionary/SearchBox.tsx",
                        lineNumber: 699,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$IstatistikBandi$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/layout/IstatistikBandi.tsx [app-ssr] (ecmascript)");
...
function SozlukEkrani({ loading, searchQuery, setSearchQuery, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, gununKelimesi, filtrelenmisSonuclar, aktifSozlukler }) {
   ...
   */ const istatistikSozlukleri = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        if (!Array.isArray(aktifSozlukler)) {
            return [];
        }
        const normallestir = (deger)=>{
            return String(deger ?? "").trim().toLocaleLowerCase("tr-TR");
        };
        ...
        return aktifSozlukler.filter((sozluk)=>{
       ...
       */ if (dosyaFiltreliMi) {
                const dosyaEslesiyor = kaynakDegerleri.some((kaynak)=>kaynak === dosyaFiltresi || kaynak.includes(dosyaFiltresi) || dosyaFiltresi.includes(kaynak));
                if (!dosyaEslesiyor) {
                    return false;
                }
            }
       ...
       */ if (lehceFiltreliMi) {
                const lehceEslesiyor = lehceDegerleri.some((lehce)=>lehce === lehceFiltresi || lehce.includes(lehceFiltresi) || lehceFiltresi.includes(lehce));
                if (!lehceEslesiyor) {
                    return false;
                }
            }
   ...
   */ const sozlukKayitSayisiniBul = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((sozluk)=>{
        if (!sozluk || typeof sozluk !== "object") {
            return 0;
        }
        const sozlukObj = sozluk;
   ...
   */ const dinamikKayitSayisi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
     ...
     * hesaplanır.
     */ const toplam = istatistikSozlukleri.reduce((genelToplam, sozluk)=>genelToplam + sozlukKayitSayisiniBul(sozluk), 0);
        return toplam;
    }, [
        searchQuery,
        gruplanmisSonuclar,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$IstatistikBandi$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    wordsCount: dinamikKayitSayisi,
                    sozlukSayisi: dinamikSozlukSayisi,
                    aktifTema: {
                        yaziAna: aktifTema.yaziAna,
                        yaziAlt: aktifTema.yaziAlt
                    }
                }, void 0, false, {
                    fileName: "[project]/src/components/dictionary/SozlukEkrani.tsx",
                    lineNumber: 752,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dictionary$2f$SearchBox$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    inputRef: inputRef,
                ...
                kaynaklarAcik && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$Kaynaklar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                tema: aktifTema,
...
function Footer({ aktifTema, onKaynaklarAc }) {
    ...
    const vurguRengi = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dictionaryConstants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["KURUMSAL"].kirmizi || "#7A1C1C";
...
;
;
function Header({ karanlikMod, toggleKaranlikMod, metinBoyutu, setMetinBoyutu, sozlukSayisi = 34, kayitSayisi = 332238, tema }) {
    ...
    const altYaziRengi = tema.yaziAlt || (karanlikMod ? "#D0C4B8" : "#4A3E37");
    const vurguRengi = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dictionaryConstants$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["KURUMSAL"].kirmizi || "#7A1C1C";
    const kontrolArkaPlanRengi = karanlikMod ? "#2C221E" : "#FFFFFF";
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>{
                                            setMetinBoyutu((oncekiBoyut)=>Math.max(12, oncekiBoyut - 2));
                                        },
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        type: "button",
                                        onClick: ()=>{
                                            setMetinBoyutu((oncekiBoyut)=>Math.min(24, oncekiBoyut + 2));
                                        },
...
"[project]/src/components/layout/IstatistikBandi.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                    ...
                    fileName: "[project]/src/components/layout/IstatistikBandi.tsx",
                    lineNumber: 30,
                    columnNumber: 9
                }, ("TURBOPACK compile-time value", void 0))
            }, void 0, false, {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: filtrelenmisManifest.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            borderColor: aktifTema.kenarlik,
                            backgroundColor: aktifTema.kartArkaPlan
                        },
                        ...
                        lineNumber: 692,
                        columnNumber: 13
                    }, this) : filtrelenmisManifest.map((sozluk)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                            style: {
                                backgroundColor: aktifTema.kartArkaPlan,
                                borderColor: aktifTema.kenarlik
                            },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/dictionaries.json.[json].js [app-ssr] (ecmascript)");
;
...
const kaynagiDuzenle = (dosyaAdi, sozluklerListesi)=>{
    ...
    const hedefListe = sozluklerListesi && sozluklerListesi.length > 0 ? sozluklerListesi : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"];
...
"[project]/src/utils/dictionaries.json.[json].js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

throw new Error("Unable to make a module from invalid JSON: expected value at line 1 column 1");
}),
...
//# sourceMappingURL=_1dw688d._.js.map