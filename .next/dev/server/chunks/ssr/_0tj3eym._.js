...
(()=>{
    const e = new Error("Cannot find module '@/utils/dictionary.json'");
...
const lehceBasligiBul = (lehce)=>{
    ...
    if (deger.includes("batı") || deger.includes("bati") || deger.includes("adıge") || deger.includes("adige") || deger.includes("doğu") || deger.includes("dogu") || deger.includes("kabardey") || deger === "kbd" || deger === "ady") {
...
const jsonKatalogunuAl = ()=>{
    const veri = dictionaryData;
    if (Array.isArray(veri)) {
        return veri.filter((item)=>Boolean(item && typeof item === "object"));
    }
    if (veri && typeof veri === "object") {
        ...
        if (Array.isArray(olasiListe)) {
            return olasiListe.filter((item)=>Boolean(item && typeof item === "object"));
        }
    }
    return [];
};
const SearchBox = ({ inputRef, searchQuery, setSearchQuery, mod, setMod, hedefDil, setHedefDil, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, aktifSozlukler = [], setGoruntulenenAdet, limit = 20, tema = {} })=>{
    ...
    const sozlukKatalogu = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>jsonKatalogunuAl(), []);
    ...
    const seciliDosyaAdi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const normalizeSeciliDosya = degeriNormallestir(seciliDosya);
        if (!seciliDosya || tumLehceDegerleri.includes(normalizeSeciliDosya)) {
            const normalizeSeciliLehce = degeriNormallestir(seciliLehce);
            if (seciliLehce && !tumLehceDegerleri.includes(normalizeSeciliLehce)) {
                ...
                children: [
                    ...
                    listeAcik && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            grupluSozlukler.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function SozlukEkrani({ loading, searchQuery, setSearchQuery, seciliLehce, setSeciliLehce, seciliDosya, setSeciliDosya, gununKelimesi, filtrelenmisSonuclar, aktifSozlukler }) {
    ...
    const hedefDilBul = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((item)=>{
        ...
        const dosyaAdi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(item.file || item.kaynak_sozluk || item).toLowerCase();
    ...
    const gruplanmisSonuclar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const gruplar = new Map();
        havuz.forEach((item)=>{
            const kelimeStr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(item.kelime);
        ...
        return Array.from(gruplar.values()).map((kaynaklar)=>{
            ...
            const kelimeBaslik = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(ilk.kelime);
            ...
            return {
                ...
                anlamlar: kaynaklar.map((k)=>{
                    ...
                    if (Array.isArray(k.definitions) && k.definitions.length > 0 && k.definitions[0]?.meaning) {
                        secilenTanim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(k.definitions[0].meaning);
                    } else if (k.full_definition_in_html) {
                        secilenTanim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(k.full_definition_in_html);
                    } else {
                        secilenTanim = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(k.tanim || k.meaning);
                    }
                    const ozelLehce = itemObj.dialect || itemObj.lehce || itemObj.diyalekt;
                    return {
                        tanim: secilenTanim,
                        file: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(k.file),
                        kaynak_sozluk: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(k.kaynak_sozluk),
    ...
    const dinamikSozlukSayisi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (lehceMetni && ![
            ...
            const kaynakListe = Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]) && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"] : aktifSozlukler;
            if (Array.isArray(kaynakListe)) {
                return kaynakListe.filter((s)=>{
                    const item = s;
        ...
        return Array.isArray(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]) ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$dictionaries$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].length : 34;
    }, [
        searchQuery,
        gruplanmisSonuclar,
        seciliDosya,
    ...
    const dinamikKayitSayisi = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (filtreVarMi) {
            ...
            if (Array.isArray(aktifSozlukler) && aktifSozlukler.length > 0) {
                return aktifSozlukler.reduce((acc, sozluk)=>{
                    if (!sozluk || typeof sozluk !== "object") return acc;
                    const rawCount = sozluk.kelimeSayisi ?? sozluk.kayitSayisi ?? sozluk.count ?? sozluk.total_words ?? 0;
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                ...
                !searchQuery?.trim() && gununKelimesi && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dictionary$2f$GununKelimesiKart$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    gununKelimesi: {
                        ...gununKelimesi,
                        kelime: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(gununKelimesi.kelime),
                        tanim: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$dictionarySources$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["metneCevir"])(gununKelimesi.tanim)
                    },
                    karanlikMod: karanlikMod,
                    metinBoyutu: metinBoyutu,
                    tema: aktifTema,
...
//# sourceMappingURL=_0tj3eym._.js.map